...
public class Client {
	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	/*out.writeObject(new Request(Constants.GET_BOAT_BY_ID, new Boat(2)));
        	...
        	/*out.writeObject(new Request(Constants.LOGIN, new User("edo", Utils.stringToDigest("x"))));
        	Response rs = (Response)in.readObject();
			System.out.println("SRV SAYS: \nSTATUS:  " + rs.getStatusCode() + "\nPAYLOAD:  " + rs.getPayload());
			System.out.print(((User)rs.getPayload()).getMembershipFee().getExpirationDate());*/
        	
        	/*out.writeObject(new Request(Constants.DELETE, new Boat(103)));
        	Response rs = (Response)in.readObject();
			System.out.println("SRV SAYS: \nSTATUS:  " + rs.getStatusCode() + "\nPAYLOAD:  " + rs.getPayload());*/
			...
			/*out.writeObject(new Request(Constants.PAY_MEMBERSHIP_FEE, (User)rs.getPayload()));
        	Response rs1 = (Response)in.readObject();
			System.out.println("SRV SAYS: \nSTATUS:  " + rs1.getStatusCode() + "\nPAYLOAD:  " + rs1.getPayload());
			System.out.print(((User)rs1.getPayload()).getMembershipFee().getExpirationDate());*/
